...
//        var filter = "";
//        $(".menu_nav li.active > a").each(function (index) {
//            var dataFilter = $(this).attr('data-filter');
//            if (dataFilter != undefined) {
//                filter = dataFilter;
//            }
//        });
//        $menu.isotope({ filter: filter + ", " + filter.replace(".menu_", ".menu-text_") });
//    });
...
//            $("div[id^=main_sub_]").hide();
//        }
//        if (filterValue == undefined) {
//            $("div[id^=main_sub_] > ul > li").removeClass("active");

//            var subId = elem.attr('id').replace('main_', 'main_sub_');
//            var subElem = $('#' + subId + '> ul li:first');
//            subElem.addClass("active");
//            filterValue = $('#' + subId + '> ul li:first > a').attr('data-filter');
//            $("#" + subId).show();
//        }
